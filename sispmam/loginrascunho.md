...
[//]: # (centralize as imagens, tire os negritos desnecessarios.) 
...
##### Obs. 3: Certifique-se junto ao P-1 de sua unidade para que os campos função e e-mail constem preenchidos corretamente em sua ficha no Comando Web. O e-mail registrado no Comando Web será o mesmo a ser cadastrado no SISPMAM, logo, se houver divergências de informações a mensagem abaixo será exibida, e não será possível realizar o seu cadastro no SISPMAM.

![Imagem de Cadastro 05](img/imgCadastroN05.jpg)

#### Passo 3: Após a Obs. 2, o próximo passo é Cadastrar senha, no campo Seu e-mail aparecerá preenchido. No campo Sua senha preencha conforme as orientações no rodapé da tela ou Obs. 4, no campo seguinte confirme a senha criada e clique em Cadastrar senha.

![Imagem de Cadastro 06](img/imgCadastroN06.jpg)

##### Obs. 4: A senha deve conter o seguinte padrão para todos os usuários: uma letra maiúscula, uma letra minúscula, um número, um caractere especial (como, por exemplo: @, !, #) e possuir um tamanho de, no mínimo, 6 (seis) dígitos.

##### Obs. 5: Ao concluir o Passo 3, será exibida a seguinte mensagem:

![Imagem de Cadastro 07](img/imgCadastroN07.jpg)

#### Passo 4: Logar na sua conta de e-mail, a cadastrada no SISPMAM e Comando Web, procurar pelo e-mail da Polícia Militar do Amazonas, abra e siga as orientações.

![Imagem de Cadastro 08](img/imgCadastroN08.jpg)

##### Obs. 6: Ao concluir o Passo 4, será exibida a seguinte mensagem.

![Imagem de Cadastro 09](img/imgCadastroN09.jpg)

##### Lembre-se: Ao acessar a sua conta sem ativá-la através do link, você receberá a mensagem de que seu e-mail não foi verificado, ou envie um novo link. O link de ativação será enviado para o seu e-mail, o mesmo cadastrado no Comando Web, é possível que seja encaminhado para a sua caixa de spam ou lixo eletrônico. Siga as instruções presentes no e-mail.

![Imagem de Cadastro 10](img/imgCadastroN10.jpg)

#### Passo 5: Ao término de todos os passos anteriores, faça login na sua conta do SISPMAM digitando seu E-mail e Senha, em seguida clique em "Entrar".

![Imagem de Cadastro 11](img/imgCadastroN11.jpg)

#### Passo 6: Ao fazer seu primeiro login, seus dados já estarão preenchidos, exceto o campo data de nascimento, clique em no ícone calendário e posteriormente ano, mês e dia de nascimento. Não se esqueça de marcar as caixas para concordar com a política de privacidade e termos de uso.

![Imagem de Cadastro 12](img/imgCadastroN12.jpg)

![Imagem de Cadastro 13](img/imgCadastroN13.jpg)

##### Obs. 7: Redefinição de senha - Todos os usuários do SISPMAM que não possuem o padrão de senha - uma letra maiúscula, uma letra minúscula, um número, um caractere especial e no mínimo, 6 (seis) dígitos - devem redefinir a senha. Digite seu e-mail e posteriormente clique no botão Redifinir senha na página principal do SISPMAM e siga as instruções enviadas para o seu e-mail. 

![Imagem de Cadastro 14](img/imgCadastroN14.jpg)

##### Obs. 8: essa é a tela do Policial Militar uma vez logado no SISPMAM. Clique em Sair para fazer logout.
